...
def load_bbox_geoms():
    ...
    for row in open("seed_data/bboxes"):
        ...
        bbox = BboxGeometry(
            bbox_id=bbox_id, route_id=route_id, bbox_geometry=bbox_geometry
        )
...
def load_edges_geoms():
    ...
    for row in open("seed_data/edges_geoms"):
        ...
        edges_geom = EdgesGeometry(
            edges_geom_id=edges_geom_id,
            route_id=route_id,
...
def load_nodes_geoms():
    ...
    for row in open("seed_data/nodes_geoms"):
        ...
        nodes_geom = NodesGeometry(
            nodes_geom_id=nodes_geom_id,
            route_id=route_id,
...
def load_routes_geoms():
    ...
    for row in open("seed_data/route_geoms"):
        ...
        route_geom_id, route_id, route_length, route_geometry = row.split(
            "|"
        )  # add length
